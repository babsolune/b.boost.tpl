...
<header id="header">
	<div id="top-header" class="content-wrapper">
    ...
    <div id="sub-header" class="content-wrapper-large">
        # IF C_VISIT_COUNTER #
...
<footer id="footer">
	<div class="frieze content-wrapper-large"></div>
	<div id="footer-container" class="content-wrapper">
	    # IF C_MENUS_TOP_FOOTER_CONTENT #
	        <div id="top-footer" class="cell-flex cell-columns-3">
	    ...
	    # IF C_MENUS_FOOTER_CONTENT #
	        <div id="footer-content" class="cell-flex cell-columns-3">
	            # START menus_footer #
	            {menus_footer.MENU}
	            # END menus_footer #
	        </div>
