...
<section id="{MODULE_NAME}# IF C_CATEGORY #_category# ENDIF #-panel" style="order: {MODULE_POSITION};">
	...
	# ELSE #
		...
		# ELSE #
			<div class="# IF C_GRID_VIEW #cell-flex cell-columns-{ITEMS_PER_ROW}# ELSE #cell-row# ENDIF #">
				...
				# START items #
					<div class="{MODULE_NAME}-item category-{items.CATEGORY_ID} cell" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
							...
							<div class="cell-infos">
								<div class="more">
									...
									# IF NOT C_DATE #
										...
										# ENDIF #
									# ENDIF #
									<span class="pinned item-category"><i class="far fa-fw fa-folder" aria-hidden="true"></i> <a itemprop="about" href="{items.U_CATEGORY}">{items.CATEGORY_NAME}</a></span>
