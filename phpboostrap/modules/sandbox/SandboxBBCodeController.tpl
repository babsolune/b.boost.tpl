...
<section>
	...
	<article class="content">
		...
		<div class="pbt-box-medium">
			...
			<div class="bbcode-media-content">
		...
		<div class="pbt-box-medium">
			<h4>{@bbcode.flash} <i class="fa fa-fw bbcode-icon-flash"></i></h4>
			<div class="bbcode-media-content">
				<object id="movie_1764_api" data="{PATH_TO_ROOT}/kernel/lib/flash/flowplayer/flowplayer.swf" type="application/x-shockwave-flash" width="100%" height="100%">
					<param name="allowfullscreen" value="true">
					<param name="allowscriptaccess" value="always">
					<param name="quality" value="high">
					<param name="cachebusting" value="false">
					<param name="bgcolor" value="#000000">
					<param name="flashvars" value="config={&quot;clip&quot;:{&quot;url&quot;:&quot;http://data.babsoweb.com/private/logo-pbt.flv&quot;,&quot;autoPlay&quot;:false},&quot;playerId&quot;:&quot;movie_1764&quot;,&quot;playlist&quot;:[{&quot;url&quot;:&quot;http://data.babsoweb.com/private/logo-pbt.flv&quot;,&quot;autoPlay&quot;:false}]}">
				</object>
			</div>
		</div>
