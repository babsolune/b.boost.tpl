<div id="${escape(HTML_ID)}_field" class="form-element-textarea# IF C_REQUIRED_AND_HAS_VALUE # constraint-status-right# ENDIF ## IF C_EDITOR_ENABLED # editor-{EDITOR_NAME}# ENDIF #"# IF C_HIDDEN # style="display:none;"# ENDIF #>
